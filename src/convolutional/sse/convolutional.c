...
correct_convolutional_sse *correct_convolutional_sse_create(size_t rate, size_t order, const polynomial_t *poly) {
    correct_convolutional_sse *conv = (correct_convolutional_sse *)malloc(sizeof(correct_convolutional_sse));
